...
public extension HDCommonTools {
    ...
    //unicode转中文
    func unicodeDecode(unicodeString: String) -> String {
        let tempStr1 = unicodeString.replacingOccurrences(of: "\\u", with: "\\U")
    ...
    //字符串转unicode
    func unicodeEncode(string: String) -> String {
    ...
    //base64解码
    func base64Decode(base64String: String, lowercase: Bool = true) -> String {
        let decodeData:Data? = Data(base64Encoded: base64String)
    ...
    //MARK: 编码
    func encryptString(_ plainText: String, encryType: HDEncryType, lowercase: Bool = true) -> String {
        let data: Data = plainText.data(using: String.Encoding.utf8) ?? Data()
